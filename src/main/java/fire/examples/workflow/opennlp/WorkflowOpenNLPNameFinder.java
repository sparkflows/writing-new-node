 ...
 */
public class WorkflowOpenNLPNameFinder {
    ...
    private static void nf(JobContext jobContext) throws Exception {
        ...
        // ner node
        NodeOpenNLPNameFinder nf = new NodeOpenNLPNameFinder(10, "nf node", "txt");
        wf.addLink(txt, nf);
