...
public class WorkflowSentiment {
    ...
    // sentiment workflow
    private static void sentiment(JobContext jobContext) {
        ...
        // sentiment node
        NodeStanfordNLPSentiment sentiment = new NodeStanfordNLPSentiment(10, "sentiment node", "f1 f2");
        //txt.addNode(sentiment);
