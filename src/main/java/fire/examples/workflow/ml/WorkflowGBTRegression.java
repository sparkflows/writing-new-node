...
import fire.nodes.etl.NodeDateTimeFiledExtract;
...
public class WorkflowGBTRegression {
    ...
    private static void executewfForecastCityBikeShare(JobContext jobContext) {
        ...
        NodeDatasetStructured clicks = new NodeDatasetStructured(1, "csv1 node", "data/Bike_Sharing_Demand/train.csv", DatasetType.CSV, "," ,
                ...
                "string int int int int double double int double int int int",
        ...
        NodeDateTimeFiledExtract dtfe = new NodeDateTimeFiledExtract(2, "dtfe");
        dtfe.inputCol = "datetime";
        dtfe.value = "year month dayofmonth hour";
        wf.addLink(ncc, dtfe);
