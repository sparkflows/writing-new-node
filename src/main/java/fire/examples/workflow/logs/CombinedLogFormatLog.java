...
import fire.nodes.logs.NodeCombinedLogFormatLog;
 ...
 */
public class CombinedLogFormatLog {
    ...
    private static void execute(JobContext jobContext) throws Exception {
        ...
        // pdf node
        NodeCombinedLogFormatLog log = new NodeCombinedLogFormatLog(1, "combined log node", "data/test.log");
        wf.addNode(log);
        ...
        // sessionize
        NodeSessionize nodeSessionize = new NodeSessionize(3, "sessionize", "ts", "ipAddress");
