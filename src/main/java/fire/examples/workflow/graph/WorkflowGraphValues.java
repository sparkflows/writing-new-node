...
import fire.nodes.graph.NodeGraphValues;
 ...
 */
public class WorkflowGraphValues {
    ...
    private static void chartswf(JobContext jobContext) throws Exception {
        ...
        // line chart node
        NodeGraphValues histogram = new NodeGraphValues(2, "graph histogram");
        String[] cols = {"rating", "movie"};
        histogram.xCol = "user";
        histogram.yCols = cols;
